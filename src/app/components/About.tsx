...
export default function About() {
  const highlights = [
    ...
    },
    {
      ...
      description: "Flyrank · Sarajevo, Europe · Completed 2026",
        ...
        >
          <div className="bg-card/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-border">
            <p className="text-lg leading-relaxed mb-6">
              I'm a <span className="text-primary font-medium">4th-year BS Computer Science student specializing in Data Science at the University of Santo Tomas</span> with hands-on industry experience. I recently completed a{" "}
              <span className="text-primary font-medium">Frontend AI Engineering internship at Flyrank (Sarajevo, Europe)</span>, where I built responsive interfaces, applied AI-assisted development workflows, and delivered 10 frontend assignments and an accepted capstone project across a July to September 2026 engagement.
            </p>
            <p className="text-lg leading-relaxed mb-6">
              Beyond the internship, I founded two products:{" "}
              <span className="font-medium">MOOVE</span>, a full-stack preventive wellness platform for Filipino drivers (React 19, TypeScript, Supabase, Groq AI; validated at 4.93/5 satisfaction and 93% task completion), and{" "}
              <span className="font-medium">Tanglaw</span>, an offline-first AI platform for Media and Information Literacy targeting digitally marginalized communities, built for the UNESCO Youth Hackathon 2026.
            </p>
            <p className="text-lg leading-relaxed mb-6">
              My technical work spans{" "}
              <span className="text-primary font-medium">frontend and full-stack engineering, AI integration, machine learning, NLP research, data engineering, and product development</span>. I have fine-tuned transformer models (93.51% accuracy on 28,503 headlines), built Kimball-modeled data warehouses processing 500K+ orders, and led teams across hackathons and real-world software projects.
            </p>
